import { login, logout, signup, verifyEmail, resendVerificationCode, loginWithGoogle, sendMailResetPassword, resetPassword } from "../../controllers/user-service/auth.controller.js";
import cors from 'cors'
import express from "express"
const router = express.Router()

const corsOptionsPublic = {
    origin: '*',  // Chỉ cho phép frontend từ localhost:5173 truy cập
