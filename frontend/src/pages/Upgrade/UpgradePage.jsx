          ...
          <div className="flex flex-col max-w-lg p-6 mx-auto text-gray-900 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                  Check attendance directly by <span className="font-semibold"> check </span> and <span className="font-semibold">QR code</span>.
                </span>
              </li>
          ...
          <div className="flex flex-col max-w-lg p-6 mx-auto text-gray-900 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                    Includes all the functions of the free version
                </span>
              </li>
              <li className="flex items-center space-x-3">
                {/* <!-- Icon --> */}
                ...
                <span>
                  Check attendance by <span className="font-semibold"> ID card </span> and <span className="font-semibold">Fingerprint</span>.
                </span>
            ...
            <a
              ...
              onClick={() => {
                openDialog()
                setAmount("1000")
                setInfo("Update to Company version")
              }}
          ...
          <div className="flex flex-col max-w-lg p-6 mx-auto text-gray-900 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                  Check attendance by <span className="font-semibold"> Face Recognition</span>.
                </span>
            ...
            <a
              ...
              onClick={() => {
                openDialog()
                setAmount("2000")
                setInfo("Update to Enterprice version")
              }}              className="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-cyan-900"
            >
              Get started
            </a>
