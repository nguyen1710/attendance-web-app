			...
			<main className='max-w-7xl mx-auto py-6 px-4 lg:px-8'>
				...
				>
					<StatCard
						...
						color='#6366F1'
					/>
					<StatCard name='New Users Today' icon={UserPlus} value={userStats.newUsersToday} color='#6366F1' />
					<StatCard
						name='Active Users'
						icon={UserCheck}
						...
						color='#6366F1'
					/>
					<StatCard name='Churn Rate' icon={UserX} value={userStats.churnRate} color='#6366F1' />
				</motion.div>
