		...
		<div className='flex-1 relative z-10 overflow-auto'>
			...
			<main className='max-w-7xl mx-auto py-6 px-4 lg:px-8'>
				...
				>
					...
					<StatCard name='Pending Orders' icon={Clock} value={orderStats.pendingOrders} color='#6366F1' />
					<StatCard
						...
						color='#6366F1'
					/>
					<StatCard name='Total Revenue' icon={DollarSign} value={orderStats.totalRevenue} color='#6366F1' />
				</motion.div>
